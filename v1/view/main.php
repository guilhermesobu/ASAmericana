<?php
if (isset($_GET['id']) && isset($_GET['conteudo']) == 'noticias') {
    //STARTANDO O CONTOLLER
    $path = $_SERVER['DOCUMENT_ROOT'];
    $path .= '/v1/controler/noticias.php';
    include $path;
...
?>
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="/v1/index.php?conteudo=noticias">Notícias</a></li>
                ...
                <div class="content" id="content">
                    ...
                    <a href="/v1/">Voltar para a página inicial.</a>
...
} else if ($_SERVER["REQUEST_URI"] == "/v1/view/main.php") { //PÁGINA INICIAL CASO NÃO TENHA GET-ID
    ?>
    <!DOCTYPE html>
    <html>
