                    ...
                    <div>
                        ...
                        <address class="col-12">
                            <div class="row">
                                ...
                                <div class="col-md-8 col-sm-12">
                                    <strong>Unidade do Serviço - Modalidade: República</strong><br>
                                ...
                                <div class="col align-self-center text-center">
                                    <a href="https://goo.gl/maps/Bikdd7L4vKgDUU75A"><img src="/src/icons/Local-Circle.png" id="common-icons" alt="Localização"></a>
                                </div>
                            </div>
                        </address>
                        ...
                        <address class="col-12">
                            <div class="row">
                                ...
                                <div class="col align-self-center text-center">
                                    <a href="https://goo.gl/maps/BF2s7pPdvryb32mK6"><img src="/src/icons/Local-Circle.png" id="common-icons" alt="Localização"></a>
                                </div>
                            </div>
                        </address>
                        ...
                        <address class="col-12">
                            <div class="row">
                                ...
                                <div class="col align-self-center text-center">
                                    <a href="https://goo.gl/maps/v7Jt8VvxG5TZwHD89"><img src="/src/icons/Local-Circle.png" id="common-icons" alt="Localização"></a>
                                </div>
                            </div>
                        </address>
                    </div>
