                    ...
                    <address class="col-12">
                        <div class="row">
                            <div class="col-md-8 col-sm-12">
                                <strong>Associação de Assistência ao Menor “Fonte de Água Viva”</strong><br>
                            ...
                            <div class="col align-self-center text-center">
                                <a href="https://goo.gl/maps/2XMEp9hryeC9W2m77"><img src="/src/icons/Local-Circle.png" id="common-icons" alt="Localização"></a>
                            </div>
                        </div>
                    </address>
                </div>
