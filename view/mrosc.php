...
<div class="container shadow rounded">
    ...
    <nav aria-label="breadcrumb" class="pt-3">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">MROSC</li>
        </ol>
    </nav>
    ...
    <div class="row-fluid p-4">
        ...
        <p>A regulamentação da Lei Federal em âmbito municipal ocorreu através do Decreto Municipal n° 11.506, de 24 de outubro de 2016, <a href="https://www.americana.sp.gov.br/legislacao/decreto_11506_2016.html">https://www.americana.sp.gov.br/legislacao/decreto_11506_2016.html</a>, que dispõe sobre a celebração de parcerias entre a administração pública e as organizações da sociedade civil, em regime de mútua colaboração, para a consecução de finalidades de interesse público e recíproco, mediante a execução de atividades, serviços, programas, projetos e benefícios previamente estabelecidos em planos de trabalho inseridos em termos de colaboração, em termos de fomento ou em acordos de cooperação, no âmbito da administração direta e indireta do Município, observadas as normas gerais estabelecidas na Lei Federal n° 13.019, de 31 de julho de 2014.</p>

        <p class="border-top pt-4">Os editais de chamamento público estão disponíveis em: </p>
        <p class="mb-0"><b>Assistência Social:</b></p>
        <p><a href="https://transparencia.americana.sp.gov.br/transparencia_index.php?p=chamamento#op01">https://transparencia.americana.sp.gov.br/transparencia_index.php?p=chamamento#op01</a></p>
        <p class="mb-0"><b>Direitos Humanos:</b></p>
