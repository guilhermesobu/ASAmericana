...
/*var myAeContentIg = [
    ...
    {    
        ...
        description: `<p>Tem direito ao benefício o cidadão maior de 18 que atenda a todos os seguintes requisitos:</p>
                ...
                <li>Que não tenha recebido em 2018 rendimentos tributáveis acima de R$ 28.559,70 (vinte e oito mil, quinhentos e cinquenta e nove reais e setenta centavos);</li>
                <li>Esteja desempregado ou exerça atividade na condição de:</li>
                    <ul>
                    <li>Microempreendedores individuais (MEI);</li>
                    <li>Contribuinte individual da Previdência Social;</li>
                    <li>Trabalhador Informal, de qualquer natureza, inclusive o intermitente inativo.</li>
                    </ul>
                </ul>`
    },
    {     
        ...
        description: `<p>Não tem direito ao Auxílio Emergencial o cidadão que:</p>
                ...
                <li>Está recebendo Seguro Desemprego;</li>
                <li>Está recebendo benefícios previdenciários, assistenciais ou benefício de transferência de renda federal, com exceção do Bolsa Família;</li>
                <li>Recebeu rendimentos tributáveis acima do teto de R$ 28.559.70 em 2018, de acordo com declaração do Imposto de Renda.</li>
                </ul>`
    },
    {     
    ...
    {     
        ...
        description: `<p>Se na mesma família houver mais de duas pessoas com trabalho informal, somente duas pessoas serão contempladas. Nesse caso, os trabalhadores informais que terão preferência para o recebimento do auxílio emergencial são:</p>
                ...
                <li>Com renda individual mais baixa; ou</li>
                <li>Para o desempate, considerando a ordem alfabética no primeiro nome.</li>
                </ul>`
    },
    {     
    ...
    },
    {
        ...
        description: `
        <a href="/perguntasfrequentes/aeinformacoes.php">AE - Informações Gerais</a><br>
        <a href="/perguntasfrequentes/aecadastramento.php">AE - CadastrAE - Cadastramento</a><br>
        <a href="/perguntasfrequentes/aeapp.php">AE - APP</a><br>
        <a href="/perguntasfrequentes/aeresultado.php">AE - Resultado da Avaliação do Cadastro</a><br>
        <a href="/perguntasfrequentes/aepagamento.php">AE - Pagamento do Benefício</a><br>
...
/*var myAeContentPb = [
    ...
    {    
        ...
        description: `<p>O valor do benefício é de três parcelas de R$ 600,00 (seiscentos reais).</p>`
    },
    {   
        title: `Quantas parcelas eu posso receber?`,
        description: `<p>Serão disponibilizadas três parcelas no valor de R$ 600,00, sendo permitido o recebimento do auxílio por até 2 pessoas da mesma família.</p>
        <p>Para as famílias em que a mulher for única responsável pela família, serão disponibilizadas duas parcelas a cada vez.</p>`
    },
    { 
        title: `Quem solicitar o auxílio depois da primeira parcela, recebe retroativo? Em quanto tempo?`,
        description: `<p>A gestão da concessão do Auxílio Emergencial ao Trabalhadores Informais é de competência do Ministério da Cidadania. O papel da CAIXA é o pagamento do benefício após a concessão e o auxílio aos cidadãos na utilização do site e aplicativo.</p>
        <p>O cadastro deve ser feito durante o período de vigência da lei, que é de 90 dias a partir da sua publicação 02/04/2020.</p>
        <p>O beneficiário pode acompanhar sua solicitação pelo App ou Site da CAIXA.</p>`
    },
    {    
        title: `Estou no Cadastro Único, vou receber automaticamente?`,
        description: `<p>O cliente que já possui Cadastro Único será automaticamente avaliado e verificado se possui os critérios para recebimento.</p>
        <p>O APP CAIXA | Auxílio Emergencial e o site da CAIXA informarão aos cidadãos já cadastrados no Cadastro Único se foi selecionado e como o pagamento será disponibilizado. Basta consultar pelo CPF em Acompanhe sua solicitação.</p>`
    },
    {    
        title: `Já estou cadastrada no Cadastro Único, por que não recebi o benefício?`,
        description: `<p>As famílias cadastradas no Cadastro Único passarão por uma seleção e receberão o Auxílio Emergencial somente se atenderem aos critérios do Programa.</p>
        <p>Caso não sejam aprovadas e não concordarem com o resultado, poderão solicitar novamente a avaliação pelo APP/Site.</p>`
    },
    {    
        title: `Eu já recebo Bolsa Família, vou receber o Auxílio Emergencial junto?`,
        description: `<p>Não. Você vai receber um dos dois benefícios, e isso vai depender do valor do seu benefício Bolsa Família.</p>
        <p>Por exemplo, se você recebe menos do que R$ 600,00 (seiscentos reais) no Programa Bolsa Família, você receberá o Auxílio Emergencial de R$ 600,00 automaticamente por três meses, e seu benefício do Bolsa ficará suspenso nesse período.</p>`
    },
    {    
        title: `Sou beneficiária do PBF. Como serei comunicada que vou receber o auxílio emergencial?`,
        description: `<p>As famílias receberão uma mensagem específica no extrato de pagamento, com informações sobre o recebimento do Auxílio Emergencial.</p>`
    },
    {    
        title: `Qual a validade das parcelas do auxílio emergencial para as famílias do PBF?`,
        description: `<p>Para as famílias do PBF a parcela do Auxílio Emergencial tem validade de 90 dias, a contar da data inicial de disponibilização.</p>`
    },
    {    
        title: `Como ficará meu benefício do Bolsa Família enquanto estiver recebendo o auxílio emergencial?`,
        description: `<p>As famílias beneficiárias do Bolsa Família terão o benefício suspenso pelo Ministério da Cidadania enquanto receberem o Auxílio Emergencial.</p>
        <p>Após o recebimento das 3 parcelas do Auxílio Emergencial, a família voltará a receber o benefício do Bolsa Família.</p>`
    },
    {     
        title: `Posso receber via cartão cidadão ou preciso abrir conta na CAIXA?`,
        description: `<p>Para receber o Auxílio Emergencial não é necessário abertura de conta. Se não for identificada conta para o beneficiário, será aberta a Poupança Digital Social.</p>`
    },
    {    
        title: `Como faço para sacar o benefício?`,
        description: `<p>Se sua família for beneficiária do Programa Bolsa Família, o(a) senhor(a) receberá o auxílio de todos os trabalhadores elegíveis da sua família (até o limite de dois auxílios) por meio do cartão do Programa Bolsa Família ou por crédito em conta da CAIXA.</p>
        <p>Se o(a) senhor(a) está inscrito no Cadastro Único, mas não é Beneficiário do Programa Bolsa Família, e cumprir os critérios para receber o auxílio, o crédito se dará de umas das três formas abaixo:</p>
            <ul>
            <li>Crédito em conta da CAIXA;</li>
            <li>Crédito em conta do Banco do Brasil;</li>
            <li>Ou será aberta automaticamente uma conta digital na CAIXA para crédito.</li>
            </ul>
        <p>O senhor poderá acompanhar a conta onde será feito o depósito por meio do site/aplicativo Auxílio Emergencial da CAIXA.</p>
        <p>Se você se cadastrou pelo site ou APP da CAIXA, o crédito será feito na conta indicada no momento da solicitação do auxílio, ou será aberta automaticamente uma conta digital na CAIXA para crédito.</p>
        <p>Caso o pagamento seja realizado em conta do tipo poupança social digital, aberta em seu nome para recebimento desse benefício, o saque poderá realizado sem cartão nas lotéricas e salas de autoatendimento da CAIXA, seguindo calendário de escalonamento específico.</p>`
    },
    {    
        title: `Tenho conta na CAIXA, por que meu benefício não caiu na conta?`,
        description: `<p>Se você já é beneficiário do Bolsa Família e tem direito ao Auxílio Emergencial, não muda nada no recebimento.</p>
        <p>Para que você receba seu benefício automaticamente em conta da CAIXA é necessário que seja beneficiário Bolsa Família, ou esteja cadastrado no Cadastro Único.</p>
        <p>Nessa situação, sua conta deverá atender aos critérios para que o valor seja pago em conta como, por exemplo, não ter nenhum tipo de bloqueio e ter movimentação nos últimos 90 dias.</p>
        <p>Caso a sua conta não atenda aos critérios de crédito, será aberta nova conta social digital em seu nome, e o seu benefício será automaticamente creditado nessa nova conta.</p>`
    },
    {    
        title: `Já tenho Cartão Cidadão, vou receber o benefício com ele?`,
        description: `<p>Caso você seja um beneficiário do Programa Bolsa Família e tenha direito ao Auxílio Emergencial aos Trabalhadores Informais, o benefício poderá ser sacado com o Cartão do Cidadão ou Cartão Bolsa Família.</p>
        <p>Caso você não seja beneficiário do Programa Bolsa Família, o pagamento será efetivado na sua conta poupança na CAIXA ou Banco do Brasil, ou ainda, por meio de conta do tipo poupança social digital, de abertura automática em nome dos beneficiários, podendo realizar o saque do valor conforme calendário de escalonamento sem cartão nas Lotéricas Caixa e Salas de Autoatendimento da CAIXA.</p>`
    },
    {    
        title: `Como faço para receber o benefício em conta?`,
        description: `<p>Se você tiver direito ao auxílio e não tiver conta no banco, a CAIXA abrirá automaticamente uma conta poupança social digital no seu nome.</p>`
    },
    {    
        title: `Vou receber um cartão para sacar o Auxílio Emergencial?`,
        description: `<p>Não. Você não receberá um cartão para esse saque.</p>
        <p>Caso o pagamento seja realizado em conta do tipo poupança social digital, aberta em seu nome para recebimento desse benefício, os recursos creditados podem ser utilizados por meio do APP CAIXA TEM para pagamentos de boletos e transferências, entre outros serviços. Além disso, o saque poderá realizado sem cartão nas lotéricas e salas de autoatendimento da CAIXA, seguindo calendário de escalonamento específico.</p>
        <p>Se você já recebe Bolsa Família com Cartão Cidadão ou Cartão Bolsa Família, o saque do Auxílio Emergencial poderá ser realizado com estes cartões.</p>
        <p>Se você não é beneficiário do Programa Bolsa Família, e o crédito foi realizado na sua conta Poupança CAIXA, o saque poderá ser realizado por meio do seu cartão da conta.</p>`
    },
    {    
        title: `Qual o calendário de escalonamento para saque dos valores do Auxílio Emergencial?`,
        description: `<p>Para quem é beneficiário do Bolsa Família, o pagamento do Auxílio Emergencial seguirá o calendário de pagamento do Bolsa Família.</p>
        <p>O Calendário de pagamento do Bolsa Família encontra-se disponível para acesso no site da CAIXA,	<a href="ttp://www.caixa.gov.br/programas-sociais/bolsa-familia/Paginas/default.aspx">clicando aqui</a></p>
        <p>Para quem está inscrito no Cadastro Único ou fez o cadastro no site ou app CAIXA | Auxílio Emergencial, foram estabelecidos cronogramas para as três parcelas.</p>
        <p>O Calendário de pagamento do Auxílio já encontra-se disponível para acesso no site da CAIXA, <a href="http://www.caixa.gov.br/auxilio/Paginas/default2.aspx">clicando aqui</a></p>
        <p>Com o objetivo de evitar aglomerações nas agências e unidades lotéricas expondo empregados, parceiros e clientes ao risco de contágio, a CAIXA escalonou o calendário de saque. Os recursos creditados na poupança digital podem ser utilizados por meio do app CAIXA Tem para pagamentos e transferências, entre outros serviços. Quem indicou conta bancária anterior ou vai receber os R$ 600 em substituição ao Bolsa Família não tem restrição para saque.</p>
        <p>Segue o calendário de saque em espécie da poupança digital sem cartão nos canais de autoatendimento e lotéricas:</p>
                <ul>
                <li>27 de abril – nascidos em janeiro e fevereiro</li>
                <li>28 de abril – nascidos em março e abril</li>
                <li>29 de abril – nascidos em maio e junho</li>
                <li>30 de abril – nascidos julho e agosto</li>
                <li>04 de maio – nascidos em setembro e outubro</li>
                <li>05 de maio – nascidos em novembro e dezembro</li>
                </ul>`
    },
    {
        title: `Posso escolher o banco que vou receber?`,
        description: `<p>Sim, se o cadastramento foi realizado pelo app CAIXA | Auxílio Emergencial ou pelo site <a href="https://auxilio.caixa.gov.br">https://auxilio.caixa.gov.br<a>.</p>
        <p>A conta indicada deve ser da titularidade do CPF que está solicitando o auxílio emergencial.</p>
        <p>No entanto, caso não seja indicada uma conta, o valor será disponibilizado em uma conta social digital, criada automaticamente para todos os beneficiários.</p>`
    },
    {    
        ...
        description: `<p>Informamos que a conta indicada deverá atender aos critérios para que o valor seja pago em conta como, por exemplo, não ter nenhum tipo de bloqueio e ter movimentação nos últimos 90 dias.</p>
        <p>Caso a conta indicada no momento do cadastramento não atenda aos critérios de crédito, será aberta automaticamente uma conta social digital em seu nome, e benefício será automaticamente creditado nessa nova conta.</p>
        <p>Será necessário que o cidadão acompanhe o resultado da avaliação pelo APP/Site com orientação sobre onde o valor será disponibilizado, caso aprovado.</p>`
    },
    {    
        ...
        description: `<p>Não, os bancos firmaram acordo para que o benefício não seja debitado das contas para esse fim.</p>`
    },
    {    
        title: `Prefiro não indicar conta para crédito do benefício pois tenho dívidas com os bancos. Como faço para receber?`,
        description: `<p>Foi feito acordo entre os bancos para que o crédito referente a esse benefício não seja usado para pagamento de dívidas bancárias automaticamente. Dessa forma, você pode habilitar normalmente o crédito em conta, sem nenhum prejuízo, evitando filas nas agências. Você também pode solicitar a abertura da conta poupança digital CAIXA, receber o benefício e fazer as movimentações pelo App Caixa Tem.</p>`
    },
    {    
        title: `Se o valor cair na conta e tiver alguma tarifa ou prestação descontado mesmo assim? Como proceder?`,
        description: `<p>Lançamentos provisionados de prestações pendentes não serão debitados do Auxílio Emergencial.
        A CAIXA disponibiliza o SAC 0800 726 0101 para registro de reclamações acerca do crédito do Auxílio Emergencial que serão sanadas prioritariamente.</p>`
    },
    {    
        ...
        description: `<p>Para esse público, será aberta automaticamente uma conta poupança social digital.</p>`
    },
    {    
        title: `Eu recebi o Bolsa Família, por que não recebi o auxílio emergencial?`,
        description: `<p>Se você já recebe Bolsa Família e atende aos critérios para receber o Auxílio Emergencial, somente irá receber o benefício mais vantajoso, ou seja, o que apresente maior valor.</p>
        <p>Dessa forma, o valor mensal do seu benefício Bolsa Família deve ser superior a RS 600,00 e por isso você não tem direto ao Auxílio Emergencial.</p>`
    },
    {   
        title: `As pessoas serão avisadas sobre a data do depósito?`,
        description: `<p>O acompanhamento do andamento da requisição, bem como do crédito do seu benefício estará disponível no mesmo aplicativo de cadastramento, na opção “ACOMPANHE SUA SOLICITAÇÃO”.</p>`
    },
    {    
        ...
        description: `<p>Todos os requisitos previstos na lei devem ser observados para ter direito ao recebimento do benefício. Dessa forma, se a pessoa tiver recebido rendimentos tributáveis acima de R$ 28.559,70 no ano de 2018, ela não está enquadrada nos critérios de recebimento.</p>`
    },
    {    
        ...
        description: `<p>Sim desde que se enquadrem em todos os critérios previstos na Lei.</p>`
    },
    {    
        title: `Como será o Saque em Espécie?`,
        description: `<p>Com o objetivo de evitar aglomerações nas agências e unidades lotéricas expondo empregados, parceiros e clientes ao risco de contágio, a CAIXA escalonou o calendário de saque. Os recursos creditados na poupança digital podem ser utilizados por meio do app CAIXA Tem para pagamentos e transferências, entre outros serviços. Quem indicou conta bancária anterior ou vai receber os R$ 600 em substituição ao Bolsa Família não tem restrição para saque.</p>
        <p>Segue o calendário de saque em espécie da poupança digital sem cartão nos canais de autoatendimento e lotéricas:</p>
                <ul>
                <li>27 de abril – nascidos em janeiro e fevereiro</li>
                <li>28 de abril – nascidos em março e abril</li>
    ...
    {    
        ...
        description: `<p>O app CAIXA | Auxílio Emergencial e o site da CAIXA informarão aos cidadãos já cadastrados no Cadastro Único se foi selecionado e como o pagamento será disponibilizado. Basta consultar pelo CPF em Acompanhe sua solicitação.</p>`
    },
    {    
        title: `Essas pessoas que não tem conta terão algum cartão para movimentar o dinheiro?`,
        description: `<p>Para quem não possui conta, será aberta a Poupança Digital Social, que tem toda sua movimentação feita por meio do App Caixa Tem, não sendo necessário a emissão de cartão físico para sua movimentação.</p>`
    },
    {
        title: `Tem mais dúvidas? Tente esses outros assuntos sobre o Auxílio Emergencial`,
        description: `
...
/*var myAeContentCe = [
    {
        ...
        <p>Nesse caso, a senhora também deve cumprir os demais requisitos do programa:</p>
            <ul>
            ...
            <li>Estar em família com renda por pessoa de até meio salário mínimo (R$ 522,50) ou com renda total de até três salários mínimos (R$ 3.135);</li>
            <li>Em 2018, não ter recebido rendimentos tributáveis acima de R$ 28.559,70 (vinte e oito mil, quinhentos e cinquenta e nove reais e setenta centavos), ou seja, não houve necessidade de declarar imposto de renda;</li>
    ...
    },
    {
        ...
        description: `<p>Nesse caso, a senhora poderá ter direito a um auxílio de R$ 1.200 reais e o(a) outro(a) trabalhador informal com até 24 anos terá direito a receber um auxílio de R$ 600,00.</p>
        <p>Nesse caso, a senhora e a outra pessoa de até 24 anos da sua família também deve cumprir os demais requisitos do programa:</p>
            <ul>
            <li>Ter mais de 18 anos de idade;</li>
            <li>Não ter emprego formal;</li>
            <li>Não receber nenhum outro benefício, como aposentadoria, BPC, seguro desemprego, auxílio doença, entre outros;</li>
    ...
    },
    {
        ...
        description: `<p>Sim. O senhor terá direito ao auxílio emergencial no valor de R$ 600,00.</p>
        <p>Nesse caso, o senhor também deve cumprir os demais requisitos do programa:</p>
            <ul>
            <li>Ter mais de 18 anos de idade;</li>
            <li>Não ter emprego formal;</li>
            <li>Não receber nenhum outro benefício, como aposentadoria, BPC, seguro desemprego, auxílio doença, entre outros;</li>
    ...
    },
    {
        ...
        description: `<p>Se o(a) senhor(a) for trabalhador rural informal (sem carteira de trabalho) e cumprir todos os requisitos do programa, o(a) senhor(a) pode ter direito ao auxílio emergencial, no valor de R$ 600,00 (seiscentos reais).</p>
        <p>Nesse caso, o senhor também deve cumprir os demais requisitos do programa:</p>
            <ul>
            <li>Ter mais de 18 anos de idade;</li>
            <li>Não ter emprego formal;</li>
    ...
    },
    {
        ...
        description: `<p>Sim. As pessoas desempregadas que não recebem seguro-desemprego podem ter direito ao auxílio emergencial.</p>
        <p>Nesse caso, o(a) senhor(a) também deve cumprir os demais requisitos do programa:</p>
            <ul>
            <li>Ter mais de 18 anos de idade;</li>
            <li>Não ter emprego formal;</li>
            <li>Não receber nenhum outro benefício, como aposentadoria, BPC, seguro desemprego, auxílio doença, entre outros;</li>
    ...
    },
    {
        ...
        description: `<p>Sim. As pessoas desempregadas que não recebem seguro-desemprego, mesmo que contribuam para o INSS como “Do lar” ou dona de casa, podem ter direito ao auxílio emergencial.</p>
        <p>Nesse caso, o(a) senhor(a) também deve cumprir os demais requisitos do programa:</p>
            <ul>
            <li>Ter mais de 18 anos de idade;</li>
            <li>Não ter emprego formal;</li>
    ...
    },
    {
        ...
        description: `<p>Os trabalhadores intermitentes que estejam sem remuneração no momento podem receber o benefício emergencial mensal previsto pela MEDIDA PROVISÓRIA Nº 936, DE 1º DE ABRIL DE 2020.</p>`
    },
    {
        title: `Recebo Benefício de Prestação Continuada (aposentadoria, LOAS), tenho direito ao auxílio emergencial?`,
        description: `<p>Não. Quem recebe o Benefício de Prestação Continuada ou aposentadoria não tem direito ao auxílio emergencial.</p>`
    },
    {
        ...
        description: `<p>Depende. Se o(a) senhor(a) fizer parte de família com renda por pessoa de até meio salário mínimo ou com renda total de até três salários mínimos pode ter direito ao auxílio emergencial, mesmo que outra pessoa da sua família receba o BPC.</p>
